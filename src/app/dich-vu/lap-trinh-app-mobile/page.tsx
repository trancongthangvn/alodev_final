...
const features = [
  { icon: 'phone', title: 'Native + Cross-platform', desc: 'Swift / Kotlin native cho native performance, hoặc React Native / Flutter cho tốc độ ship.' },
    ...
    <>
      ...
      <section id="hero" className="mag-section mag-bg-paper relative overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-24">
          ...
          <div className="mt-6">
            <p className="mag-section-index">Dịch vụ · Mobile</p>
            ...
            <p className="mag-body-lead mt-4 max-w-3xl leading-relaxed">
              ...
              Sử dụng <b className="text-ink-700 dark:text-ink-200">Swift/Kotlin native</b> cho native performance, hoặc <b className="text-ink-700 dark:text-ink-200">React Native/Flutter</b> cho tốc độ triển khai cả hai nền tảng đồng thời.
      ...
      <section className="mag-section mag-bg-paper py-12 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mag-section-head !mt-3">Sáu phần Alodev xử lý trọn gói</h2>
          </div>
      ...
      <section className="mag-section mag-bg-tint py-12 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <p className="mag-section-index">Loại app</p>
            <h2 className="mag-section-head !mt-3">Năm dòng app Alodev triển khai</h2>
          </div>
      ...
      <section className="mag-section mag-bg-paper py-12 lg:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            ...
            <h2 className="mag-section-head !mt-3">Câu hỏi thường gặp về lập trình app</h2>
          </div>
      ...
      <section id="cta" className="mag-section mag-bg-tint py-12 lg:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="mag-section-head">Sẵn sàng phát triển app?</h2>
