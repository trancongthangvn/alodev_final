    ...
    <main id="main" className="relative min-h-[70vh] flex items-center bg-white dark:bg-ink-950">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-ink-900 hover:bg-ink-800 dark:bg-white dark:text-ink-900 dark:hover:bg-ink-100 px-6 py-3.5 text-base font-semibold text-white transition"
          >
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <Icon name="arrow-right" className="w-4 h-4 text-gray-400 dark:text-ink-500 group-hover:translate-x-0.5 transition" />
      </div>
      <p className="mt-1 text-xs text-gray-500 dark:text-ink-500">{desc}</p>
    </Link>
  )
}
