...
export const projects: Project[] = [
  {
    ...
    shortDesc: 'Restream cloud cho seller livestream - 1 nguồn phát đồng thời Shopee, TikTok, Facebook. Không cần PC mạnh hay OBS.',
    longDesc: 'SaaS restream: 1 video gốc → fan-out 3 đích qua FFmpeg server-side. Auto-bitrate, scheduler lịch phát, dashboard realtime viewer chart, billing 3 gói + invoice tự động.',
  ...
  },
  {
    ...
    shortDesc: 'Mạng xã hội thương mại - feed, shop seller, đơn hàng, chat realtime. PWA cài được từ homescreen.',
    longDesc: 'Social + commerce hybrid: user post kiếm điểm, mua bán trong shop riêng. XP/leaderboard, wishlist, cart, order tracking, seller dashboard. PWA iOS/Android - install homescreen, offline-first feed.',
  ...
  },
  {
    ...
    shortDesc: 'Ôn thi THPT - khoá học video, ngân hàng đề, đấu trường real-time, livestream đa nền tảng.',
    longDesc: 'Học trực tuyến: khoá học HD, ngân hàng đề chấm tự động, đấu trường PvP real-time với XP/streak, livestream HLS (YouTube + Facebook + native), mobile app Capacitor (iOS + Android).',
