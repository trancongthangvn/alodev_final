...
export default function SmoothScroll() {
  useEffect(() => {
    ...
    // Homepage uses a fixed-frame layout - .mag-scroll handles internal
    // smooth scroll natively. Lenis (which targets window scroll) would
    // intercept anchor clicks and try to scroll a non-scrollable body.
    if (document.querySelector('.mag-scroll')) return
